...
export function CtaSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative overflow-hidden bg-[#ecece8] py-24 lg:py-32"
    >
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
        <div
          className={`relative border border-foreground/20 bg-[#f7f7f3] transition-all duration-1000 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
          }`}
          onMouseMove={handleMouseMove}
        >
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col items-start gap-4 sm:flex-row">
                  ...
                  <Button
                    ...
                    size="lg"
                    variant="outline"
                    className="h-14 rounded-full border-foreground/20 bg-white/40 px-8 text-base hover:bg-white/70"
                  >
                    <Link href="/work">View our work</Link>
                  </Button>
                </div>
